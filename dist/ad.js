...
/* harmony export */ });
/* harmony import */ var _components_BannerAD__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _components_CoupletAD__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _components_InterstitialAD__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var _components_RollupAD__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);




/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({ BannerAD: _components_BannerAD__WEBPACK_IMPORTED_MODULE_0__["default"], CoupletAD: _components_CoupletAD__WEBPACK_IMPORTED_MODULE_1__["default"], InterstitialAD: _components_InterstitialAD__WEBPACK_IMPORTED_MODULE_2__["default"], RollupAD: _components_RollupAD__WEBPACK_IMPORTED_MODULE_3__["default"] });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BannerAD)
/* harmony export */ });
/* harmony import */ var _AD__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

// 实例化 指定广告类型
class BannerAD extends _AD__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
// 广告类
class AD extends _core__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BASE_CORE)
/* harmony export */ });
/* harmony import */ var _mock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
class BASE_CORE {
    ...
    // 初始化style
    initStyle(dom = this.$DOM.$ad, styles = this.$state.options.style || 'width:100%;height:100%;') {
        dom.style.cssText = styles;
        var style = document.createElement('style');
        style.innerHTML = _style__WEBPACK_IMPORTED_MODULE_2__.CSS_ad_close_icon_after;
        this.appendChild(document.head, style);
    }
    // 初始化删除按钮
    initCloseBtn() {
        const delbox = document.createElement('div');
        const adtxt = document.createElement('div');
        delbox.id = 'ad-close-icon';
        adtxt.id = 'ad-txt';
        adtxt.innerHTML = '广告';
        delbox.style.cssText = _style__WEBPACK_IMPORTED_MODULE_2__.CSS_ad_close_icon;
        adtxt.style.cssText = _style__WEBPACK_IMPORTED_MODULE_2__.CSS_ad_txt;
        this.$DOM.$delIcon = document.createElement('div');
        this.$DOM.$delIcon.id = 'ad-close-icon-box';
        this.$DOM.$delIcon.style.cssText = _style__WEBPACK_IMPORTED_MODULE_2__.CSS_ad_close_icon_box;
        // 插入dom
        ...
        // 绑定close事件
        this.registerEvent(this.$DOM.$delIcon, 'click', (e) => this.onClose(e));
    }
    // 初始化通用监听事件
    initEvent(el, options) {
        // console.log(el);
        el.addEventListener(options.event, _event__WEBPACK_IMPORTED_MODULE_1__["default"][options.event](options));
    }
    // 模拟请求
    fetch(appkey, adtype) {
        return _mock__WEBPACK_IMPORTED_MODULE_0__.applist.find((f) => f.appkey == appkey)
    ...
    initRenderEvent() {
        // 创建实例
        this.$mutationObserver_show = new MutationObserver(() => console.log('曝光了...', this.$DOM.$ad));
        this.$mutationObserver_show.observe(this.$DOM.$container, {
            childList: true,
        });
    }
    appendChild(father, child) {
        father.appendChild(child);
    }
    registerEvent(dom, operation, event) {
        ...
        AD_value: [
            {
                ...
                showType: 'image',
                // 图片
                image: 'https://img-operation.csdnimg.cn/csdn/silkroad/img/1662634720055.png',
                // 触发事件
                event: 'click',
                // 计费
                money: 10,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CSS_ad_close_icon": () => (/* binding */ CSS_ad_close_icon),
/* harmony export */   "CSS_ad_close_icon_after": () => (/* binding */ CSS_ad_close_icon_after),
/* harmony export */   "CSS_ad_close_icon_box": () => (/* binding */ CSS_ad_close_icon_box),
/* harmony export */   "CSS_ad_txt": () => (/* binding */ CSS_ad_txt),
/* harmony export */   "CSS_close_btn": () => (/* binding */ CSS_close_btn)
/* harmony export */ });
const CSS_ad_close_icon_after = `
  #ad-close-icon::after {
  content: '';
  display: block;
  width: 15px;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CoupletAD)
/* harmony export */ });
/* harmony import */ var _AD__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

// 实例化 指定广告类型
class CoupletAD extends _AD__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(el, options) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InterstitialAD)
/* harmony export */ });
/* harmony import */ var _AD__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

// 实例化 指定广告类型
class InterstitialAD extends _AD__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(el, options) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RollupAD)
/* harmony export */ });
/* harmony import */ var _AD__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

// 实例化 指定广告类型
class RollupAD extends _AD__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(el, options) {
        super(el, Object.assign(Object.assign({}, options), { adtype: 'RollupAD', style: 'width:100%;height:100%;', name: 'rollupad' }));
        this.initAD(this.$DOM.$ad, this.$resource);
        this.initRollbox();
    }
    // 初始化广告内容
    ...
    initRollbox() {
        ...
        // 滚动事件
        let isroll = false;
        this.registerEvent(rollbtn, 'click', (e) => {
            if (!isroll) {
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("ad." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateAD"] = (chunkId, moreModules, runtime) => {
